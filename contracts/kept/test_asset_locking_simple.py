...
class SimpleAssetLockingTest:
    ...
    def generate_test_report(self, test_results):
        ...
        # 保存详细结果
        with open('asset_locking_test_results.json', 'w') as f:
            json.dump(test_results, f, indent=2, default=str)
        
        logger.info("📄 详细结果已保存到: asset_locking_test_results.json")

def main():
    """主函数"""
    test = SimpleAssetLockingTest()
