...
def use_existing_connection():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if active_connections:
                ...
                their_did = connection.get('their_did', 'Unknown')
                my_did = connection.get('my_did', 'Unknown')
            ...
            print(f"❌ 无法获取连接: HTTP {response.status_code}")
            return False
    ...
    cross_chain_data = {
        ...
        "transaction_hash": "0x777888999aaa111",
...
if __name__ == "__main__":
    success = use_existing_connection()
    if success:
        print("\n✅ 使用现有连接生成跨链VC成功！")
    else:
        print("\n❌ 使用现有连接生成跨链VC失败！")
