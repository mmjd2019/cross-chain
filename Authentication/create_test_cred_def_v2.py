...
# -*- coding: utf-8 -*-
"""
快速创建InspectionReport的Schema和CredDef（新版本）
使用新版本号避免与ledger上已有的冲突
"""
...
if resp.status_code in [200, 201]:
    ...
    with open("test_cred_def_result_v2.json", "w") as f:
        json.dump(result, f, indent=2)
    print(f"\n  ✓ 结果已保存到 test_cred_def_result_v2.json")
    print(f"\n新的CredDef ID: {cred_def_id}")
